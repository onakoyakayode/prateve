    ...
    <div className='flex flex-col'>
        ...
        <div className='h-auto md:h-[390px] px-[20px] flex flex-col-reverse md:flex md:flex-row items-center md:items-start justify-center gap-[30px] md:gap-[89px] mt-[40px] md:mt-[73px]'>
            <div className=' w-[100%] md:w-[436px] flex flex-col items-start mt-[33px]'>
                ...
                <Link className='mt-[51px] bg-primaryColor text-textColorLight text-[15px] md:text-[16px] rounded-[10px] py-[15px] px-[30px] flex items-center justify-center font-Grotesk w-[100%] md:w-auto h-[60px]' href="">Learn more</Link>
            </div>
        ...
        <div className='h-auto md:h-[450px] px-[20px] flex flex-col-reverse items-center md:items-start md:flex-row-reverse bg-[#D2E6F3] py-[50px] justify-center gap-[20px] md:gap-[89px] mt-[73px]'>
            <div className='w-[100%] md:w-[436px] flex flex-col items-start mt-[33px]'>
                ...
                <p className='text-textColor2 font-Grotesk text-[100%]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ultricies tristique mollis lacus ultrices feugiat curabitur tempus arcu, est. Risus mauris ultrices tellus ante purus tortor sem sit purus. Non tempus libero cras sed congue mi. Leo arcu sed maecenas aliquet ut quam.</p>
                <Link className='mt-[30px] bg-primaryColor text-textColorLight text-[15px] md:text-[16px] rounded-[10px] py-[15px] px-[30px] font-Grotesk flex items-center justify-center w-[100%] md:w-auto h-[60px]' href="">Learn more</Link>
            </div>
        ...
        <div className='h-auto md:h-[390px] px-[20px] flex flex-col-reverse md:flex md:flex-row items-center md:items-start justify-center gap-[20px] md:gap-[89px] mt-[73px]'>
            <div className='w-[100%] md:w-[436px] flex flex-col items-start mt-[33px]'>
                ...
                <p className='text-textColor2 font-Grotesk text-[100%]'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ultricies tristique mollis lacus ultrices feugiat curabitur tempus arcu, est. Risus mauris ultrices tellus ante purus tortor sem sit purus. Non tempus libero cras sed congue mi. Leo arcu sed maecenas aliquet ut quam.</p>
                <Link className='mt-[51px] bg-primaryColor text-textColorLight text-[15px] md:text-[16px] rounded-[10px] py-[15px] px-[30px] font-Grotesk flex items-center justify-center w-[100%] md:w-auto h-[60px]' href="">Learn more</Link>
            </div>
        ...
        <div className='flex items-center justify-center pt-[100px] pb-[35px]'>
            <div className='h-auto md:h-[404px] w-[90%] md:w-[920px] bg-primaryColor rounded-[20px] p-[30px] md:p-[60px]'>
                <h1 className='w-[100%] md:w-[302px] text-secondaryColor opacity-80 text-[28px] md:text-[32px] mb-[70px] md:mb-[149px]'>Create an Account In Simple Steps...</h1>
                <Link className='flex items-center gap-[15px] justify-center text-[15px] md:text-[16px] w-[100%] md:w-[199px] h-[55px] md:h-[65px] rounded-[10px] bg-[#D2E6F3] text-primaryColor py-[15px] px-[30px] font-Grotesk' href="/CreateAccount">Get started <ArrowForwardIcon /></Link>
            </div>
        </div>
